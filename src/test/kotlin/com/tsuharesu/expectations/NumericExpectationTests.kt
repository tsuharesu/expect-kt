...
class NumericExpectationTests {
    ...
    fun toBeGreaterOrEqualTo() {
        ...
        }.message.should.be("2 expected to be greater than or equal to 3")
        ...
        }.message.should.be("2.0 expected to be greater than or equal to 3.0")
    ...
    fun toBeGreaterThan() {
        ...
        }.message.should.be("2 expected to be greater than 2")
        assertFailsWith(AssertionError::class) {
            expect(2).toBeGreaterThan(3)
        }.message.should.be("2 expected to be greater than 3")
        ...
        }.message.should.be("2.0 expected to be greater than 2.0")
        assertFailsWith(AssertionError::class) {
            expect(2.toDouble()).toBeGreaterThan(3.0)
        }.message.should.be("2.0 expected to be greater than 3.0")
    ...
    fun toBeLessOrEqualTo() {
        ...
        }.message.should.be("2 expected to be less than or equal to 1")
        ...
        }.message.should.be("2.0 expected to be less than or equal to 1.0")
    ...
    fun toBeLessThan() {
        ...
        }.message.should.be("2 expected to be less than 2")
        ...
        }.message.should.be("2.0 expected to be less than 2.0")
    ...
    fun toBeInRange() {
        ...
        }.message.should.be("2 expected to be between 3 and 6")
        ...
        }.message.should.be("2.0 expected to be between 3.0 and 6.0")
    ...
    fun toBeApproximately() {
        ...
        }.message.should.be("2 expected to be between 3 and 13")
        ...
        }.message.should.be("2.0 expected to be between 2.3 and 3.3")
